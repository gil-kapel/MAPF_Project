...
Colors = ['green', 'blue', 'orange', 'red', 'yellow', 'pink', 'cyan', 'purple']


class Animation:
    def __init__(self, my_map, starts, goals, paths, speed=10):
        ...
        self.fig = plt.figure(frameon=False, figsize=(20 * aspect, 20 * aspect))
